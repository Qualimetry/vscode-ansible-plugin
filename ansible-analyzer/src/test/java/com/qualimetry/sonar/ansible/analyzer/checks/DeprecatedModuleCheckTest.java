...
class DeprecatedModuleCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        DeprecatedModuleCheck check = new DeprecatedModuleCheck();
    ...
    @Test
    void whenImportPlaybook_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Import
    ...
    void whenInclude_reportsIssue() {
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-replace-deprecated-module");
        assertThat(context.getIssues().get(0).message()).contains("import_playbook");
    }

    @Test
    void whenCopy_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Copy
