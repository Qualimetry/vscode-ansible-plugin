...
class BecomeUserNotRootCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        BecomeUserNotRootCheck check = new BecomeUserNotRootCheck();
    ...
    @Test
    void whenBecomeUserIsNotRoot_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
    ...
    @Test
    void whenBecomeUserIsRoot_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run as root
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-become-non-root-user");
    }

    @Test
    void whenNoBecomeUser_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Ping
