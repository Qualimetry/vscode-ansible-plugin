...
class HandlerNamingCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        HandlerNamingCheck check = new HandlerNamingCheck();
    ...
    @Test
    void whenNoHandlers_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Ping
    ...
    @Test
    void whenHandlerHasName_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks: []
              handlers:
    ...
    @Test
    void whenHandlerWithoutName_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks: []
              handlers:
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-handler-has-name");
    }
}
