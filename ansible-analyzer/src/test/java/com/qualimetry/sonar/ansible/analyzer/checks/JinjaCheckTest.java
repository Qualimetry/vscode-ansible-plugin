...
class JinjaCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        JinjaCheck check = new JinjaCheck();
    ...
    @Test
    void whenJinjaNoSpaces_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Set var
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-jinja-format");
        assertThat(context.getIssues().get(0).line()).isEqualTo(5);
    }

    @Test
    void whenJinjaWithSpaces_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Set var
