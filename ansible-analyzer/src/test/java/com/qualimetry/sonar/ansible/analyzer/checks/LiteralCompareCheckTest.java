...
class LiteralCompareCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        LiteralCompareCheck check = new LiteralCompareCheck();
    ...
    @Test
    void whenWhenIsSimpleVar_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
    ...
    @Test
    void whenWhenIsLiteralCompare_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run when enabled
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-avoid-literal-bool-compare");
    }

    @Test
    void whenNoWhen_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Ping
