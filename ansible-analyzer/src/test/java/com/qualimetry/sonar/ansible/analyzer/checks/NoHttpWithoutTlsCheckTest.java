...
class NoHttpWithoutTlsCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        NoHttpWithoutTlsCheck check = new NoHttpWithoutTlsCheck();
    ...
    @Test
    void whenUrlIsHttps_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Download
    ...
    @Test
    void whenUrlIsHttp_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Download
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-require-https");
    }

    @Test
    void whenNoUrl_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Ping
