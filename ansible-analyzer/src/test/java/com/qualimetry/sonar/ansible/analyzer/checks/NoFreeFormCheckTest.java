...
class NoFreeFormCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        NoFreeFormCheck check = new NoFreeFormCheck();
    ...
    @Test
    void whenCommandWithArgs_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run
    ...
    @Test
    void whenCommandFreeForm_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-command-args-form");
    }

    @Test
    void whenShellFreeForm_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run
