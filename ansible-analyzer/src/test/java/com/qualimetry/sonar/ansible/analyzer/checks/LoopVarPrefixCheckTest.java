...
class LoopVarPrefixCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        LoopVarPrefixCheck check = new LoopVarPrefixCheck();
    ...
    @Test
    void whenLoopVarWithPrefix_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Loop
    ...
    @Test
    void whenLoopVarDefaultItem_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Loop
    ...
    @Test
    void whenLoopVarWithoutPrefix_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Loop
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-prefix-loop-var");
    }

    @Test
    void whenNoLoopControl_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Ping
