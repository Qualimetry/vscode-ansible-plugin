...
class VarNamingCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        VarNamingCheck check = new VarNamingCheck();
    ...
    @Test
    void whenVarNameValid_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - set_fact:
    ...
    @Test
    void whenVarNameInvalid_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - set_fact:
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-variable-name-format");
    }
}
