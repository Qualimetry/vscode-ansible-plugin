...
class RiskyShellPipeCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        RiskyShellPipeCheck check = new RiskyShellPipeCheck();
    ...
    @Test
    void whenShellNoPipe_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Echo
    ...
    @Test
    void whenShellWithPipe_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Count
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-shell-pipe-safe");
    }

    @Test
    void whenShellWithPipeInArgs_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Count
    ...
    @Test
    void whenCommand_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run
