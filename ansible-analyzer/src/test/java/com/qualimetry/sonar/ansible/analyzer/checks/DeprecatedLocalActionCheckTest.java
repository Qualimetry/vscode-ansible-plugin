...
class DeprecatedLocalActionCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        DeprecatedLocalActionCheck check = new DeprecatedLocalActionCheck();
    ...
    @Test
    void whenNoLocalAction_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Ping
    ...
    @Test
    void whenLocalAction_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Local
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-delegate-to-localhost");
        assertThat(context.getIssues().get(0).message()).contains("delegate_to");
    }
}
