...
class KeyOrderCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        KeyOrderCheck check = new KeyOrderCheck();
    ...
    @Test
    void whenNameBeforeModule_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Copy file
    ...
    @Test
    void whenModuleBeforeName_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - copy:
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-task-name-first");
        assertThat(context.getIssues().get(0).message()).contains("name").contains("copy");
    }
}
