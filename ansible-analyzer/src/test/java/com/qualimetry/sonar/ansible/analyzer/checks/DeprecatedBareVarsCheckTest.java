...
class DeprecatedBareVarsCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        DeprecatedBareVarsCheck check = new DeprecatedBareVarsCheck();
    ...
    @Test
    void whenBareWhen_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run when
    ...
    @Test
    void whenJinjaWhenBareVar_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run when
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-bare-var-in-condition");
    }

    @Test
    void whenLoopBareVar_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Loop
    ...
    @Test
    void whenLoopList_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Loop
