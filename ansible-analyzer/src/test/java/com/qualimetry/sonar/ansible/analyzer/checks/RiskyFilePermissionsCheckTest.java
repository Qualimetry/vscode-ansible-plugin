...
class RiskyFilePermissionsCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        RiskyFilePermissionsCheck check = new RiskyFilePermissionsCheck();
    ...
    @Test
    void whenSafeMode_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Copy
    ...
    @Test
    void whenMode0777_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Copy
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-restrict-file-mode");
    }
