...
class CommandInsteadOfShellCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        CommandInsteadOfShellCheck check = new CommandInsteadOfShellCheck();
    ...
    @Test
    void whenCommandModule_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Echo
    ...
    @Test
    void whenShellWithSimpleCmd_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Echo
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-command-not-shell-when-possible");
    }

    @Test
    void whenShellWithPipe_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Count
    ...
    @Test
    void whenShellWithPipeInArgs_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Count
