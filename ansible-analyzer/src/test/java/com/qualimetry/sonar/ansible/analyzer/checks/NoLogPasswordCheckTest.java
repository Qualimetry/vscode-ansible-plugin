...
class NoLogPasswordCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        NoLogPasswordCheck check = new NoLogPasswordCheck();
    ...
    @Test
    void whenNoPasswordKey_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Ping
    ...
    @Test
    void whenPasswordWithNoLog_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Set password
    ...
    @Test
    void whenPasswordWithoutNoLog_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Set password
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-no-log-secrets");
    }
}
