...
class NoJinjaWhenCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        NoJinjaWhenCheck check = new NoJinjaWhenCheck();
    ...
    @Test
    void whenBareVariable_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run when
    ...
    @Test
    void whenJinjaBareVar_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run when
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-when-bare-variable");
    }
