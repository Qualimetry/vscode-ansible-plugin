...
class NoDuplicateTasksCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        NoDuplicateTasksCheck check = new NoDuplicateTasksCheck();
    ...
    @Test
    void whenNoDuplicateTasks_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Install foo
    ...
    @Test
    void whenDuplicateTaskNameAndModule_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-unique-tasks");
    }

    @Test
    void whenTasksSameModuleDifferentNames_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: First
