...
class DeprecatedParameterCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        DeprecatedParameterCheck check = new DeprecatedParameterCheck();
    ...
    @Test
    void whenNoDeprecatedParam_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Copy
    ...
    @Test
    void whenForceParam_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Copy
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-replace-deprecated-param");
        assertThat(context.getIssues().get(0).message()).contains("state");
    }
}
