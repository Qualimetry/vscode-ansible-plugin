...
class TaskNameMinLengthCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        TaskNameMinLengthCheck check = new TaskNameMinLengthCheck();
    ...
    @Test
    void whenNameLongEnough_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Ping host
    ...
    @Test
    void whenNameTooShort_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Hi
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-task-name-min-chars");
    }

    @Test
    void whenNoName_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - ping:
