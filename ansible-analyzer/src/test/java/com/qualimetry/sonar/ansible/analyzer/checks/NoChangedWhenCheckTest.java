...
class NoChangedWhenCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        NoChangedWhenCheck check = new NoChangedWhenCheck();
    ...
    @Test
    void whenCommandWithChangedWhen_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run
    ...
    @Test
    void whenCommandWithoutChangedWhen_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Run
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-command-changed-when");
    }
