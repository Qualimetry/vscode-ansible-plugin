...
class PartialBecomeCheckTest {
    ...
    private AnsibleContext runCheck(String yaml) {
        ...
        PartialBecomeCheck check = new PartialBecomeCheck();
    ...
    @Test
    void whenBecomeUserWithBecomeTrue_reportsNoIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Do it
    ...
    @Test
    void whenBecomeUserWithoutBecome_reportsIssue() {
        String yaml = """
            - hosts: all
              tasks:
                - name: Do it
        ...
        assertThat(context.getIssues().get(0).ruleKey()).isEqualTo("qa-become-with-user");
    }
